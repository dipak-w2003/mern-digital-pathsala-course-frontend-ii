...
import { createInstituteCourse, fetchInstituteCourse } from "@/lib/store/institute/course/courseSlice"
import { ICoursePostData } from "@/lib/store/institute/course/courseSlice.type"
...
const CourseModal: React.FC<ICloseModal> = ({ closeModal }) => {
  ...
  const handleCourseSubmission = async (e: ChangeEvent<HTMLFormElement>) => {
    ...
    if (status === Status.SUCCESS) {
      closeModal()
      console.log("Submission Datas :",courseData)
    }
  }
  useEffect(() => {
